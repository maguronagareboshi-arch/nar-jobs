...
export const SYSTEMS = [
  ...
  },
  {
    ...
    // §289 要領 8/29 改定版 6.(4): Ｃ３下 は第10サイクル(9 月の開催)以降 180万円以下(第9サイクルまで 200万円以下)。
    //   lines= 今の線。linesUntil= [[この日より前, その線]](cloud/class_calc.py lines_on が日付で選ぶ)。nar-viewer の class.js と同じ
    lines: [['Ａ', '1,100万円 超'], ['Ｂ', '700万円 超 〜 1,100万円 以下'], ['Ｃ1', '460万円 超 〜 700万円 以下'],
      ['Ｃ2', '300万円 超 〜 460万円 以下'], ['Ｃ3上', '180万円 超 〜 300万円 以下'], ['Ｃ3下', '180万円 以下']],
    linesUntil: [['2026-09-01', [['Ａ', '1,100万円 超'], ['Ｂ', '700万円 超 〜 1,100万円 以下'], ['Ｃ1', '460万円 超 〜 700万円 以下'],
